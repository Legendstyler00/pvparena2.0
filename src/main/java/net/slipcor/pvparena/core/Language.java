...
public final class Language {
    ...
    public enum MSG {
        ...
        ERROR_JOIN_MODULE("nulang.error.nojoinmodule", "There is no join module in your arena configuration. You have to set one!"),
        ...
        INFO_MOD_REPLACEMENT("nulang.info.mod_replacement", "Module &a%1%&r will replace &a%2%&r module."),
        INFO_MOD_DISABLED("nulang.info.mod_disabled", "Module disabled: &a%1%&r"),
        INFO_MOD_NOT_REMOVABLE("nulang.info.mod_not_removable", "Module &a%1%&r can't be removed. It have to be replaced by a module having the same type (%2%)"),
