...
public class PAGoalFlagSaveEvent extends PAGoalEvent {
     ...
     */
    public PAGoalFlagSaveEvent(final Arena arena, final ArenaGoal goal, final ArenaPlayer arenaPlayer, final ArenaTeam flagTeam) {
        super(arena, goal);
